...
public class Marks extends JFrame implements ActionListener {
    ...
    Marks(String rollno) {
        ...
        JLabel heading = new JLabel("Presidency Univeristy");
        ...
        try {
            ...
            while(rs2.next()) {
                sub1.setText(sub1.getText() + " _____  " + rs2.getString("marks1")+"  out of 100");
                sub2.setText(sub2.getText() + " _____  " + rs2.getString("marks2")+"  out of 100");
                sub3.setText(sub3.getText() + " _____  " + rs2.getString("marks3")+"  out of 100");
                sub4.setText(sub4.getText() + " _____  " + rs2.getString("marks4")+"  out of 100");
                sub5.setText(sub5.getText() + " _____  " + rs2.getString("marks5")+"  out of 100");
